    ...
    resources: {
      en: {
        translation: {
          ...
          mainTitleText: "Back-end Developer",
          mainAboutText: "Hello, my name is Felipe. I’m a web developer. I build interfaces with <1>React</1> and <3>Blazor</3> and APIs using ASP.NET.",
      ...
      pt: {
        translation: {
          ...
          mainTitleText: "Desenvolvedor <br> Back-end",
          mainAboutText: "Olá, meu nome é Felipe. Sou desenvolvedor web, crio interfaces usando <1>React</1> e <3>Blazor</3> e APIs usando ASP.NET.",
